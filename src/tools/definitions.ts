...
export const toolDefinitions: ToolDefinition[] = [
  ...
  },
  {
    ...
    name: "UUID Generator",
    description:
      "Generate UUID v4 (random), v5 (namespaced SHA-1, deterministic) or v7 (timestamp-sortable). Copy individually or all at once.",
    category: "developer",
    aliases: [
      "guid",
      "uuid v4",
    ...
    keywords: ["uuid", "guid", "unique", "id", "generate", "v4", "v5", "v7", "namespace", "sortable"],
    relatedToolSlugs: ["password-generator", "hash-generator", "hmac-generator"],
    available: true,
  },
  {
    id: "dev-url-encode",
  ...
  // ── Colors ──────────────────────────────────────────────
  {
    ...
    description:
      "Convert any color to any format — hex to RGB, RGB to hex, oklch to hex, and more. Paste any CSS color and get all formats at once.",
    category: "colors",
    aliases: [
      "hex to rgb",
      "rgb to hex",
    ...
    relatedToolSlugs: ["hex-to-oklch", "css-color-vars-converter", "contrast-checker"],
    available: true,
  },
  {
    id: "colors-hex-to-oklch",
    slug: "hex-to-oklch",
    name: "Hex to OKLCH",
    description:
      "Convert hex colors to the modern OKLCH color space — perceptually uniform and the new CSS default.",
    category: "colors",
    aliases: ["oklch converter", "hex oklch", "css oklch", "oklch css"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["oklch", "hex", "color", "css", "convert", "perceptual"],
    relatedToolSlugs: ["color-converter", "css-color-vars-converter", "contrast-checker"],
    available: true,
  },
  {
    id: "colors-css-vars-converter",
    slug: "css-color-vars-converter",
    name: "CSS Color Vars Converter",
    description:
      "Paste a block of CSS custom properties and batch-convert every color value to OKLCH, HEX, RGB or HSL — non-color values stay untouched.",
    category: "colors",
    aliases: [
    ...
    relatedToolSlugs: ["color-converter", "hex-to-oklch", "contrast-checker"],
    available: true,
  },
  {
    id: "color-contrast",
  ...
  // ── Images: Phase 6 additions ───────────────────────────
  {
    id: "image-jpg-to-png",
    slug: "jpg-to-png",
    name: "JPG to PNG",
    description:
      "Convert JPG and JPEG images to PNG format with lossless quality.",
    category: "images",
    aliases: ["jpeg to png", "convert jpg", "jpeg png"],
    inputKind: "file",
    outputKind: "file",
    processingMode: "client",
    supportsBatch: true,
    ...
    relatedToolSlugs: ["png-to-jpg", "jpg-to-webp", "crop-image"],
    available: true,
  },
  {
    id: "image-crop",
    ...
    name: "Crop Image",
    description:
      "Crop images to specific dimensions by pixel position, with an optional centered square mode.",
    category: "images",
    aliases: ["cut image", "trim image", "image crop"],
    inputKind: "file",
    outputKind: "file",
    processingMode: "client",
    supportsBatch: true,
    ...
    options: [
      {
        ...
        default: 0,
        min: 0,
        help: "X position of the crop area's top-left corner.",
      },
      {
        key: "top",
        label: "Top (px)",
        ...
        default: 0,
        min: 0,
        help: "Y position of the crop area's top-left corner.",
      },
      {
        key: "width",
        label: "Width (px)",
      ...
      },
      {
        ...
        type: "switch",
        default: false,
        help: "Grow the crop to a centered square of the larger dimension.",
      },
    ],
    keywords: ["crop", "cut", "trim", "image", "dimensions"],
    relatedToolSlugs: ["resize-image", "rotate-image", "image-watermark"],
    available: true,
  },
  {
    id: "image-watermark",
    ...
    description:
      "Overlay a text watermark on images with configurable position, size, and opacity.",
    category: "images",
    aliases: ["watermark", "copyright image", "stamp image"],
    inputKind: "file",
    outputKind: "file",
    processingMode: "client",
    supportsBatch: true,
    ...
    keywords: ["watermark", "text", "copyright", "overlay", "image"],
    relatedToolSlugs: ["crop-image", "compress-image", "resize-image"],
    available: true,
  },

  // ── PDF: Phase 6 additions ───────────────────────────────
  {
    id: "pdf-images-to-pdf",
    slug: "images-to-pdf",
    name: "Images to PDF",
    description:
      "Combine JPG, PNG, or WebP images into a single PDF — one image per page, in your chosen order.",
    category: "pdf",
    aliases: ["jpg to pdf", "png to pdf", "photo to pdf", "image pdf"],
    inputKind: "file",
    outputKind: "file",
    processingMode: "client",
    supportsBatch: false,
    ...
    maxFileSizeMB: 50,
    maxFiles: 100,
    keywords: ["images", "pdf", "convert", "combine", "photo"],
    relatedToolSlugs: ["merge-pdf", "pdf-to-images", "jpg-to-png"],
    available: true,
  },
  {
    id: "pdf-to-text",
    ...
    name: "PDF to Text",
    description:
      "Extract all text content from a PDF file, page by page, entirely in your browser.",
    category: "pdf",
    aliases: ["extract text", "pdf text", "pdf txt"],
    inputKind: "file",
    outputKind: "file",
    processingMode: "client",
    supportsBatch: false,
    ...
    maxFileSizeMB: 100,
    maxFiles: 1,
    keywords: ["pdf", "text", "extract", "txt", "content"],
    relatedToolSlugs: ["pdf-to-images", "merge-pdf", "split-pdf"],
    available: true,
  },

  // ── Developer: Phase 6 additions ─────────────────────────
  {
    ...
    category: "developer",
    aliases: ["validate json", "json lint", "json check"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["json", "validate", "lint", "check", "syntax", "error"],
    relatedToolSlugs: ["json-formatter", "json-diff", "json-minifier"],
    available: true,
  },
  {
    id: "dev-json-diff",
    ...
    category: "developer",
    aliases: ["compare json", "json compare", "json changes"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["json", "diff", "compare", "changes", "difference"],
    relatedToolSlugs: ["json-formatter", "json-validator", "text-diff"],
    available: true,
  },
  {
    id: "dev-password-generator",
    slug: "password-generator",
    name: "Password Generator",
    description:
      "Generate cryptographically secure passwords with custom length, character sets, and strength estimation.",
    category: "developer",
    aliases: ["random password", "secure password", "password maker"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["password", "generator", "random", "secure", "entropy"],
    relatedToolSlugs: ["uuid-generator", "hash-generator", "hmac-generator"],
    available: true,
  },
  {
    id: "dev-hmac-generator",
    slug: "hmac-generator",
    name: "HMAC Generator",
    description:
      "Generate HMAC signatures (SHA-1/256/384/512) from a message and secret key using WebCrypto — nothing leaves your browser.",
    category: "developer",
    aliases: ["hmac", "hmac sha256", "signature", "mac"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["hmac", "hash", "signature", "sha256", "webcrypto", "secret"],
    relatedToolSlugs: ["hash-generator", "password-generator", "jwt-decoder"],
    available: true,
  },

  // ── Text: Phase 6 additions ──────────────────────────────
  {
    id: "text-sort-lines",
    slug: "sort-lines",
    name: "Sort Lines",
    description:
      "Sort text lines alphabetically, numerically, by length, or shuffle them randomly.",
    category: "text",
    aliases: ["sort text", "alphabetize", "line sorter"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["sort", "lines", "alphabetical", "order", "shuffle"],
    relatedToolSlugs: ["remove-duplicate-lines", "whitespace-cleaner", "case-converter"],
    available: true,
  },
  {
    ...
    description:
      "Deduplicate text lines with optional case-insensitive and whitespace-trim matching.",
    category: "text",
    aliases: ["dedupe", "unique lines", "remove duplicates"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["duplicate", "unique", "dedupe", "lines", "remove"],
    relatedToolSlugs: ["sort-lines", "whitespace-cleaner", "word-counter"],
    available: true,
  },
  {
    ...
    name: "Find & Replace",
    description:
      "Replace text or regex patterns across your input with live match counting.",
    category: "text",
    aliases: ["replace text", "search replace", "substitute"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    ...
    relatedToolSlugs: ["sort-lines", "text-diff", "case-converter"],
    available: true,
  },
  {
    ...
    category: "text",
    aliases: ["html entities", "escape html", "unescape html"],
    inputKind: "text",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    ...
    relatedToolSlugs: ["url-encode-decode", "base64-encode-decode", "html-minifier"],
    available: true,
  },
  {
    id: "text-lorem-ipsum",
    ...
    description:
      "Generate placeholder text as paragraphs, sentences, or words with the classic opening.",
    category: "text",
    aliases: ["lorem", "placeholder text", "dummy text", "filler text"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
  ...
  // ── Date & Time: Phase 6 additions ──────────────────────
  {
    id: "datetime-timezone-converter",
    slug: "timezone-converter",
    name: "Timezone Converter",
    description:
      "Convert a date and time across all common timezones at once, using your browser's IANA timezone data.",
    category: "datetime",
    aliases: ["time zone", "utc converter", "world clock"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    ...
    relatedToolSlugs: ["timestamp-converter", "date-difference", "age-calculator"],
    available: true,
  },
  {
    ...
    description:
      "Calculate the exact duration between two dates in years, months, days, weekdays, hours and minutes.",
    category: "datetime",
    aliases: ["date calculator", "days between", "duration calculator"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["date", "difference", "duration", "days between", "calculator"],
    relatedToolSlugs: ["age-calculator", "timestamp-converter", "timezone-converter"],
    available: true,
  },
  {
    ...
    name: "Age Calculator",
    description:
      "Calculate exact age in years, months and days, plus total days lived and days until the next birthday.",
    category: "datetime",
    aliases: ["how old am i", "birthday calculator", "age from birthdate"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["age", "birthday", "years old", "calculator", "birthdate"],
    relatedToolSlugs: ["date-difference", "timestamp-converter", "timezone-converter"],
    available: true,
  },

  // ── Converters: Phase 6 additions ───────────────────────
  {
    id: "converter-base",
    slug: "base-converter",
    name: "Base Converter",
    description:
      "Convert numbers between binary, octal, decimal and hexadecimal with instant copy.",
    category: "converters",
    aliases: ["binary converter", "hex converter", "number base"],
    inputKind: "none",
    outputKind: "text",
    processingMode: "client",
    supportsBatch: false,
    requiresAuthentication: false,
    keywords: ["binary", "octal", "decimal", "hexadecimal", "base", "number"],
